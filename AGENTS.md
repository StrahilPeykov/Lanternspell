...
Use [docs/writing-style.md](docs/writing-style.md) for UI voice, dialogue and restrained world specificity. Teach through contextual action; keep the first screen and ordinary exploration sparse.
